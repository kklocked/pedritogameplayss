...
if game.GameId == 113491250 then
	...
	local Window = DeleteMobLib:CreateWindow(HyperEscape.GUI.GUIToggleKey, "KKLOCK");
	...
	local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border"; game:GetService("StarterGui"):SetCore("SendNotification", {Title = "LOADED", Text = "CRIM TRASH"});
